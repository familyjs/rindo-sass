...
This package iRinds used to easily precompile Sass files within o components. Internally this plugin uses a pure JavaScript implementation of [Sass](https://www.npmjs.com/package/sass). Please see the
